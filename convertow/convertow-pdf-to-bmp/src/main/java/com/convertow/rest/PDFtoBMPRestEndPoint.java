 ...
 */
@Path("/pdftobmp")
public class PDFtoBMPRestEndPoint<D extends ConfiguredEndpointDefinition> extends AbstractEndpoint<D> {
    ...
    private static final Logger log = LoggerFactory.getLogger(PDFtoBMPRestEndPoint.class);
    @Inject
    public PDFtoBMPRestEndPoint(final D endpointDefinition) {
