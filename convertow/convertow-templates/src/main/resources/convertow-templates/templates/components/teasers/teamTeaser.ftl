        ...
        <div class="team-member-info">
            ...
            <div class="social-profiles">
                [#if content.twitterLink?has_content]
                    <a target="_blank" href="${content.twitterLink!}"><i class="mdi mdi-twitter"></i></a>
                [/#if]
                [#if content.facebookLink?has_content]
                    <a target="_blank" href="${content.facebookLink!}"><i class="mdi mdi-facebook"></i></a>
                [/#if]
                [#if content.linkedinkLink?has_content]
                    <a target="_blank" href="${content.linkedinkLink!}"><i class="mdi mdi-linkedin"></i></a>
                [/#if]
                [#if content.instagramkLink?has_content]
                    <a target="_blank" href="${content.instagramkLink!}"><i class="mdi mdi-instagram"></i></a>
                [/#if]
            </div>
        </div>
    </div>
